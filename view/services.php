        						...
        						<div class="filter-view">
									<div class="filter-block">
										...
										<div class="check-slide">
											...
											<input name="sample-checkbox-01" id="checkbox-1" value="1" type="checkbox">Wedding Flowers</label>
										</div>
										<div class="check-slide">
											<label class="label_check" for="checkbox-2">
											<input name="sample-checkbox-01" id="checkbox-2" value="1" type="checkbox">Balloon Decorations</label>
										</div>
										<div class="check-slide">
											<label class="label_check" for="checkbox-3">
											<input name="sample-checkbox-01" id="checkbox-3" value="1" type="checkbox">Room Decor</label>
										</div>
										<div class="check-slide">
											<label class="label_check" for="checkbox-4">
											<input name="sample-checkbox-01" id="checkbox-4" value="1" type="checkbox">Car Decoration</label>
										</div>
									</div>
        						</div>
        						<div class="filter-view">
